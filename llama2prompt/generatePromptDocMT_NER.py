...
def main():
  ...
  promptDocMtF = open(args.inputF+'.promptdocmt-ner_docmt', 'w')
  promptSenMtF = open(args.inputF+'.promptdocmt-ner_senmt', 'w')
  promptDocRefF = open(args.inputF+'.promptdocmt-ner_docref', 'w')
  promptSenRefF = open(args.inputF+'.promptdocmt-ner_senref', 'w')
