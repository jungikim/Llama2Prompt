...
class LLaMa2NER():
  def __init__(self,
               model_dir,
               system_prompt=None,
               user_prompt='Provide descriptions of any ambiguous acronyms or named entities in the following text in a tabular format: '):
                          #'What can be ambiguous acronyms or named entities in this article?: '):
  ...
  def __call__(self, inputStr):
    ...
    return Util._getEntriesFromTable(text_output)
