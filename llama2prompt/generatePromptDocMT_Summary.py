...
def main():
  ...
  promptDocMtF = open(args.inputF+'.promptdocmt-sum_docmt', 'w')
  promptSenMtF = open(args.inputF+'.promptdocmt-sum_senmt', 'w')
  promptDocRefF = open(args.inputF+'.promptdocmt-sum_docref', 'w')
  promptSenRefF = open(args.inputF+'.promptdocmt-sum_senref', 'w')
