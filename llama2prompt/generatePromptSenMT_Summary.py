...
def main():
  ...
  promptDocMtF = open(args.inputF+'.promptsenmt-sum_docmt', 'w')
  promptSenMtF = open(args.inputF+'.promptsenmt-sum_senmt', 'w')
  promptDocRefF = open(args.inputF+'.promptsenmt-sum_docref', 'w')
  promptSenRefF = open(args.inputF+'.promptsenmt-sum_senref', 'w')
